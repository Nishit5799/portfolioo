...
const Page12_About = () => {
  return (
    <>
      ...
      <h1 className="sm:w-[80%] sm:rounded-3xl text-outline-black mx-auto px-2 sm:text-[4vw] sm:leading-none sm:-mt-[10vw]  text-[12vw] text-center  sm:px-0 text-white/90 font-jelly">
        Let me introduce myself..
      </h1>
    </>
  );
